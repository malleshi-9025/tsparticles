  ...
  interact(p1) {
    ...
    for (const p2 of query) {
      ...
      const pos2 = p2.getPosition(),
        ...
        dx,
        dy
      } = (0, Utils_1.getDistances)(pos1, pos2),
...
const utils_1 = __webpack_require__(3157);
...
async function loadPolygonMaskPlugin(tsParticles) {
  if (!(0, Utils_1.isSsr)() && !window.SVGPathSeg) {
    await Promise.resolve().then(() => __importStar(__webpack_require__(3776)));
  }
